...
public class GoalManager
{
    ...
    public void SaveGoals()
    {
        ...
        using (StreamWriter outputFile = new StreamWriter(filename))
        {
            for (int i = 0; i < _goals.Count; i++)
            {
                outputFile.WriteLine($"{_goals[i].GetType()},{_goals[i].GetStringRepresentation()}");
            }
        }
    }
    public void LoadGoals()
    {
        ...
        foreach (string line in lines)
        {
            ...
            {
                _goals.Add(new SimpleGoal(shortHand, description, points));
            }
            else if (goalType == "EternalGoal")
            {
                _goals.Add(new EternalGoal(shortHand, description, points));
            }
            else if (goalType == "ChecklistGoal")
            {
                ...
                _goals.Add(new ChecklistGoal(shortHand, description, points, target, bonus));
            }
        }
    }
}
